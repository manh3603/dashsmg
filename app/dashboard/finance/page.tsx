...
function FinancePageContent() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-bold text-slate-900">Tài chính & Thu nhập</h1>
        <p className="mt-1 text-slate-600">Số dư, báo cáo, rút tiền, lịch sử và chia sẻ doanh thu — đồng bộ khi có API cửa hàng</p>
      </div>
